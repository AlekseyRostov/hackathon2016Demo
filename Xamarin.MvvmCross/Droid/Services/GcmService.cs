...
using Android.Util;
using Gcm.Client;
using CoreConstants = Feedback.API.Constants;
using Feedback.Droid.Views.Places;
...
namespace Feedback.Droid.Services
{
    ...
    public class GcmService : GcmServiceBase
    {
        ...
        protected override void OnMessage(Context context, Intent intent)
        {
            ...
            {
                CreateNotification("New feedback added", message);
            }
        }
        ...
        private void CreateNotification(string title, string desc)
        {
            ...
            var uiIntent = new Intent(this, typeof(PlacesActivity));
